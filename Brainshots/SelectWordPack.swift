...
class SelectWordPack: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func playButtonAction() {
        ...
        appDelegate.IPSession.sendMessage(message: "startPlay", peerID: CommonFunctions.sharedInstance.getHostID())
